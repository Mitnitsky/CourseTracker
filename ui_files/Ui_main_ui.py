...
# Form implementation generated from reading ui file '/home/vov4ik/Projects/CourseTracker/ui_files/main_ui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.grades_table = QtWidgets.QTableWidget(self.frame_2)
        ...
        self.table_header = QtWidgets.QLabel(self.frame_2)
...
"text-decoration: underline;")
        ...
        self.start_button_2 = QtWidgets.QPushButton(self.frame_3)
        self.start_button_2.setEnabled(False)
        self.start_button_2.setStyleSheet("")
        self.start_button_2.setObjectName("start_button_2")
        self.horizontalLayout_2.addWidget(self.start_button_2)
        self.stop_button_2 = QtWidgets.QPushButton(self.frame_3)
        self.stop_button_2.setEnabled(False)
        self.stop_button_2.setStyleSheet("")
        self.stop_button_2.setObjectName("stop_button_2")
        self.horizontalLayout_2.addWidget(self.stop_button_2)
        self.gridLayout_9.addLayout(self.horizontalLayout_2, 3, 0, 1, 1)
        self.gradesTrackerheader_2 = QtWidgets.QLabel(self.frame_3)
        self.gradesTrackerheader_2.setStyleSheet("font: 18pt \"Noto Sans\";\n"
"text-decoration: underline;")
        self.gradesTrackerheader_2.setObjectName("gradesTrackerheader_2")
        self.gridLayout_9.addWidget(self.gradesTrackerheader_2, 1, 0, 1, 1)
        self.soundNotification_2 = QtWidgets.QCheckBox(self.frame_3)
        self.soundNotification_2.setObjectName("soundNotification_2")
        self.gridLayout_9.addWidget(self.soundNotification_2, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.start_button_2.setToolTip(_translate("MainWindow", "<html><head/><body><p>You must get the grades for the course first!</p></body></html>"))
        self.start_button_2.setText(_translate("MainWindow", "Start"))
        self.stop_button_2.setText(_translate("MainWindow", "Stop"))
        self.gradesTrackerheader_2.setText(_translate("MainWindow", "Grades Tracker:"))
        self.soundNotification_2.setToolTip(_translate("MainWindow", "<html><head/><body><p>Notify will be sounded when new grade is found</p></body></html>"))
        self.soundNotification_2.setText(_translate("MainWindow", "Sound notification "))
